...
//#define kGradientBottomColor [UIColor colorWithWhite:0.353 alpha:kBoxAlpha]
#define kGradientBottomColor [UIColor lightGrayColor]

//top color white value in gradient bg
//#define kGradientTopColor [UIColor colorWithWhite:0.353 alpha:kBoxAlpha]
#define kGradientTopColor [UIColor lightGrayColor]
